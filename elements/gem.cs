...
public partial class gem : Area2D
{
	...
	private async void _on_body_entered(Node2D body)
	{
		if (!consumed)
		{
			...
			{
				this.consumed = true;
				gameplay.ChangePlayerGold(this.AddsGold);
				...
				tweenAlpha.TweenProperty(this, "modulate:a", 1, 0.25);
				tweenAlpha.TweenProperty(this, "modulate:a", 0, 0.5);
