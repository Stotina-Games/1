...
func _on_body_entered(body: Node2D):
	...
	self.consumed = true;
	gameplay.ChangePlayerHP(self.RestoresHP);
	...
	tweenAlpha.tween_property(self, "modulate:a", 1, 0.5);
	tweenAlpha.tween_property(self, "modulate:a", 0, 0.25);
